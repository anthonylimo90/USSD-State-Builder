...
class PostgreSQLStorage extends StorageInterface {
     ...
     * @param {number} [config.poolConfig.max=10] - Maximum number of connections in the pool
     * @param {number} [config.poolConfig.min=0] - Minimum number of idle connections
     * @param {number} [config.poolConfig.idleTimeoutMillis=30000] - Idle connection timeout in ms
     * @param {number} [config.poolConfig.connectionTimeoutMillis=0] - Connection timeout in ms (0 = no timeout)
    ...
    /**
     * Execute operations atomically using PostgreSQL transactions
